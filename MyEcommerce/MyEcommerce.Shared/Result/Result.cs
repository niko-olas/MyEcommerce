...
public class Result
{
    ...
    public static Result<TValue> Ok<TValue>(TValue value) => new Result<TValue>(value, true, Error.None);
    ...
    public static Result<TValue> Create<TValue>(TValue value, Error error)
        where TValue : class
        => value is null ? Fail<TValue>(error) : Ok(value);
    ...
    /// </remarks>
    public static Result<TValue> Fail<TValue>(Error error) => new Result<TValue>(default!, false, error);
